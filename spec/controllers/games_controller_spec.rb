...
describe GamesController do
  ...
  let(:valid_attributes) { { "date" => "2013-12-31" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved game as @game" do
        ...
        post :create, {:game => { "date" => "invalid value" }}, valid_session
        assigns(:game).should be_a_new(Game)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game" do
        ...
        Game.any_instance.should_receive(:update).with({ "date" => "2013-12-31" })
        put :update, {:id => game.to_param, :game => { "date" => "2013-12-31" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the game as @game" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Game.any_instance.stub(:save).and_return(false)
        put :update, {:id => game.to_param, :game => { "date" => "invalid value" }}, valid_session
        assigns(:game).should eq(game)
      end
