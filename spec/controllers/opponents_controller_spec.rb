  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved opponent as @opponent" do
        ...
        post :create, {:opponent => { "school_name" => "invalid value" }}, valid_session
        assigns(:opponent).should be_a_new(Opponent)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested opponent" do
        ...
        Opponent.any_instance.should_receive(:update).with({ "school_name" => "MyString" })
        put :update, {:id => opponent.to_param, :opponent => { "school_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the opponent as @opponent" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Opponent.any_instance.stub(:save).and_return(false)
        put :update, {:id => opponent.to_param, :opponent => { "school_name" => "invalid value" }}, valid_session
        assigns(:opponent).should eq(opponent)
      end
