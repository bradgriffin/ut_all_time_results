...
describe ResultsController do
  ...
  let(:valid_attributes) { { "result" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved result as @result" do
        ...
        post :create, {:result => { "result" => "invalid value" }}, valid_session
        assigns(:result).should be_a_new(Result)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested result" do
        ...
        Result.any_instance.should_receive(:update).with({ "result" => "MyString" })
        put :update, {:id => result.to_param, :result => { "result" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the result as @result" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Result.any_instance.stub(:save).and_return(false)
        put :update, {:id => result.to_param, :result => { "result" => "invalid value" }}, valid_session
        assigns(:result).should eq(result)
      end
